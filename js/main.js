...
/*  { position: [-33.0424716740458, -71.63064379907598], number:23, name: "<strong>La Dulceria</strong>", foto: "<a href='https://www.instagram.com/ladulceriavalpo/' target='_blank'><img src='img/023_la_dulceria.jpg' alt='Placeholder Image 1'></a>" },*/
  ...
  { position: [-33.0275506534088, -71.6530909362516], number:26, name: "<strong>Mirador - Faro Punta Angeles </strong>", foto: "<a href='https://vlpo.cl/mirador-faro-punta-angeles/' target='_blank'><img src='img/026_mirador_faro.jpeg' alt='Placeholder Image 1'></a>" },
/*  { position: [-33.01773047807142, -71.55303276568115], number:27, name: "<strong>A Mano Gin & Burgers</strong>", foto: "<a href='https://www.instagram.com/a_mano_ginyburgers/' target='_blank'><img src='img/027_mano_gin_burger.jpg' alt='Placeholder Image 1'></a>" },*/
  { position: [-33.082340833009816, -71.66297173094044], number:28, name: "<strong>Mirador Laguna Verde</strong>", foto: "<a href='https://pt.foursquare.com/v/mirador-sector-laguna-verde/4eaeb3787ee59f1609775699' target='_blank'><img src='img/028_laguna_verde.jpg' alt='Placeholder Image 1'></a>" },
  { position: [-33.114132851219104, -71.66910590700111], number:29, name: "<strong>Hospedagem - Airbnb</strong>", foto: "<a href='https://www.airbnb.com.br/' target='_blank'><img src='img/029_house.jpg' alt='Placeholder Image 1'></a>" }
...
locations.forEach(function(local) {
  var customIcon = L.divIcon({
    html: '<div class="custom-marker green">' + local.number + '</div>',
    className: '',
    iconSize: [30, 30]
  });
  ...
  L.marker(local.position, { icon: customIcon }).addTo(map)
  .bindPopup(local.name + local.foto);
});
